#!/bin/bash
#
# Revokes temporary access to port 443 in security group for IP of machine
# that this script is run on. Used to teardown AWS access from CircleCI
...
# Revoke access to public IP of this machine
